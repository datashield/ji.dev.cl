#' 
#' @title Indicates which elements are missing
#' @description This function is similar to R function \code{is.na}. 
...
#' variable is the name of the input variable with the suffixe '_isna' (e.g. 'LAB_TSC_isna', if input 
...
#' }
#' 
ji.ds.isNA = function(datasources=NULL, x=NULL, newobj=NULL){
