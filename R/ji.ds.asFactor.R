#' 
#' @title Turns a vector into factor type
#' @description This function is similar to R function \code{as.factor}. 
...
#' variable is the name of the input variable with the suffixe '_factor' (e.g. 'GENDER_factor', if input 
...
#' }
#' 
ji.ds.asFactor = function(datasources=NULL, xvect=NULL, newobj=NULL){
  ...
  if(is.null(newobj)){
    newobj <- paste0(varname, "_factor")
  }
  
  # call the server side function that does the job
  cally <- call('as.factor', xvect )
